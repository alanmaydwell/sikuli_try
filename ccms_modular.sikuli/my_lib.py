...
"""
Classes and functions that directly work with Sikuli
...
class BaseSik(object):
    """
    Generic Sikulix
    Choose path(s) with image files.
    Generic methods for waiting and clicking the images
    ...
    def wait_with_pauses(self, image, delay=1, iterations=10):
        found = wait_with_pauses(image, delay, iterations)
